...
//print("The value of foo is \(foo)") -> will not work because foo is a local scope only in the for loop and cannot be used outside the loop
...
//here, x is defined as a global scope and hence can be used everywhere in the code till the last line of the code
...
greeting(greeting: "Yo wassup", name: "Bhavesh")
greeting(greeting: nil, name: "Pragnya")
/*:
 ...
 */
class Car{
    var make: String = "ncjd"
    var model: String = "bwcke"
    var year: Int = 2345
}
